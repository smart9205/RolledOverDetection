...
#define YOLO_MODEL_PATH "yolov5s_t40_magik.bin"
#define FACE_MODEL_PATH "face.bin"

extern struct chn_conf chn[];
std::unique_ptr<venus::BaseNet> yolo_net;
...
static int sample_venus_init()
{
	...
	yolo_net = venus::net_create(TensorFormat::NV12);
	face_net = venus::net_create(TensorFormat::NV12);

    ret = yolo_net->load_model(YOLO_MODEL_PATH);
